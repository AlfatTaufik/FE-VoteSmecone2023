        ...
        <div className=" shadow-lit flex bg-[#FFFFFF] mt-[8rem] rounded-lg py-[1rem] px-[1rem] xxs:mx-auto md:mx-auto lg:mx-auto">
          ...
          <div className="flex flex-col">
            ...
            <form action="" className="xxs:px-[1rem] md:px-[3rem] lg:px-[4rem]">
              <input type="number" placeholder="Kode OTP" className="lg:w-[450px] flex text-primary font-semibold border-2 shadow-pit xxs:px-4 md:px-6 py-[3rem] rounded-md mb-[30px]" />
